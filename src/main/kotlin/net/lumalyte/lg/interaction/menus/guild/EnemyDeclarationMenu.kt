...
class EnemyDeclarationMenu(
    ...
    override fun open() {
        ...
        val gui = ChestGui(6, MenuTitleBuilder.build(guild.guiTheme, 6, lang.guiTitle("menu.enemy_declaration.title")))
    ...
    private fun updateGuildsDisplay() {
        ...
        if (pageGuilds.isEmpty()) {
            ...
            val emptyItem = ItemStack.of(Material.BARRIER)
                .name(lang.gui("menu.enemy_declaration.empty.name"))
                .lore(lang.gui("menu.enemy_declaration.empty.description"))
                .lore(lang.gui("menu.enemy_declaration.empty.detail"))
    ...
    private fun createGuildItem(targetGuild: Guild): ItemStack {
        ...
        item.name(lang.gui("menu.enemy_declaration.guild.name", "guild" to targetGuild.name))
            .lore(lang.gui("menu.enemy_declaration.guild.members", "count" to memberCount))
            .lore(lang.gui("menu.enemy_declaration.guild.level", "level" to targetGuild.level))
            .lore(
                if (targetGuild.mode.name == "PEACEFUL") {
                    lang.gui("menu.enemy_declaration.guild.mode.peaceful")
                } else {
                    lang.gui("menu.enemy_declaration.guild.mode.hostile")
                }
            )
            .lore(lang.gui("menu.common.blank"))
            .lore(lang.gui("menu.enemy_declaration.guild.action"))

        return item
    }

    private fun openConfirmation(targetGuild: Guild) {
        val gui = ChestGui(3, MenuTitleBuilder.build(guild.guiTheme, 3, lang.guiTitle("menu.enemy_declaration.title")))
        ...
        val confirmItem = ItemStack.of(Material.RED_CONCRETE)
            .name(lang.gui("menu.enemy_declaration.confirm.name"))
            .lore(lang.gui("menu.enemy_declaration.confirm.guild", "guild" to targetGuild.name))
            .lore(lang.gui("menu.enemy_declaration.confirm.description"))
            .lore(lang.gui("menu.common.blank"))
            .lore(lang.gui("menu.enemy_declaration.confirm.warning"))
        ...
        val cancelItem = ItemStack.of(Material.ARROW)
            .name(lang.gui("menu.enemy_declaration.cancel.name"))
            .lore(lang.gui("menu.enemy_declaration.cancel.description"))
    ...
    private fun addNavigationButtons(pane: StaticPane) {
        ...
        if (currentPage > 0) {
            val prevItem = ItemStack.of(Material.ARROW)
                .name(lang.gui("menu.enemy_declaration.navigation.previous.name"))
                .lore(lang.gui("menu.enemy_declaration.navigation.previous.description"))
        ...
        val pageItem = ItemStack.of(Material.PAPER)
            .name(lang.gui("menu.enemy_declaration.navigation.page", "page" to currentPage + 1, "pages" to if (totalPages > 0) totalPages else 1))
            .lore(lang.gui("menu.enemy_declaration.navigation.total", "count" to allGuilds.size))
        ...
        if (currentPage < totalPages - 1) {
            val nextItem = ItemStack.of(Material.ARROW)
                .name(lang.gui("menu.enemy_declaration.navigation.next.name"))
                .lore(lang.gui("menu.enemy_declaration.navigation.next.description"))
    ...
    private fun addBackButton(pane: StaticPane, x: Int, y: Int) {
        val backItem = ItemStack.of(Material.ARROW)
            .name(lang.gui("menu.enemy_declaration.navigation.back.name"))
            .lore(lang.gui("menu.enemy_declaration.navigation.back.description"))
